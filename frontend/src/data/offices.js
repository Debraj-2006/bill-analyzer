// src/data/offices.js — Static WBSEDCL office data (mirrors backend seed)
// Used when the backend is offline so the OfficeLocator still works.
...
// Filter offices by district / type / search term (mirrors backend query)
export function filterOffices(offices, { searchTerm = '', district = '', type = '' } = {}) {
